...
import { growthStage, PETS, type CompanionPreferences, type PetId, type PetPose } from '../lib/companions'
import mole from '../assets/companions/mallet-mole.png'
import sparrow from '../assets/companions/rice-sparrow.png'
import sprout from '../assets/companions/mochi-sprout.png'

const artwork = { mole, sparrow, sprout }

export function CompanionSprite({ petId, pose = 'idle', stage = 1, animate = false }: { petId: PetId; pose?: PetPose; stage?: number; animate?: boolean }) {
...
export function CompanionHome({ preferences, points, ready, disabled, onChange }: {
  preferences: CompanionPreferences; points: Record<PetId, number>; ready: boolean; disabled: boolean
...
export function ResultCompanion({ petId, points, gained, animate }: { petId: PetId; points: number; gained: number; animate: boolean }) {
